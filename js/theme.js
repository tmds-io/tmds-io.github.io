...
//const baseHue = 10;
//const rangeHue = 100;
const baseHue = [220, 345, 20];
const rangeHue = [30, 25, 20];
const noiseSteps = 2;
const xOff = 0.0025;
const yOff = 0.005;
const zOff = 0.0005;
...
function initParticle(i) {
    let theta, x, y, vx, vy, life, ttl, speed, size, hueIndex, hue;
    ...
    hueIndex = Math.floor(rand(baseHue.length));
    hue = (baseHue[hueIndex] + rand(rangeHue[hueIndex])) % 360;
